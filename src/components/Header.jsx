            ...
            <nav className="container mx-auto max-w-7xl flex justify-between items-center px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <a aria-label="LinkedIn"
                        className="text-gray-600 dark:text-gray-400 hover:text-primary transition-colors" href="https://www.linkedin.com/in/mehad-hossen/">
                        <svg aria-hidden="true" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    <a aria-label="Email"
                        className="text-gray-600 dark:text-gray-400 hover:text-primary transition-colors" href="mailto:mehad004938@gmail.com">
                        <svg aria-hidden="true" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="container mx-auto px-4 pt-2 pb-4 space-y-1">
                            {navLinks.filter(link => link.name !== 'Home').map((link) => (
                                <NavLink
                                    key={link.name}
                                    to={link.href}
                                    className={({ isActive }) => `block px-3 py-2 rounded-md text-base font-medium ${isActive ? 'text-primary bg-gray-50 dark:bg-gray-800' : 'text-gray-700 dark:text-gray-200 hover:text-primary hover:bg-gray-50 dark:hover:bg-gray-800'}`}
