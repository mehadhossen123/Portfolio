    ...
    <div className="flex-grow container mx-auto max-w-7xl flex items-center px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full py-12 md:py-24">
        ...
        >
          ...
          <div className="overflow-hidden mb-4">
            <motion.h2
              ...
              className="text-4xl md:text-5xl font-semibold text-gray-700 dark:text-gray-300 block"
            >
              Hi, I am
            </motion.h2>
          </div>
          ...
          <div className="overflow-hidden mb-6">
            <motion.h1
              variants={revealVariants}
              className="text-6xl md:text-8xl font-bold text-gray-900 dark:text-white block"
            >
              Mehad Hossen
            </motion.h1>
          </div>
          ...
          <motion.p
            ...
            className="text-2xl md:text-3xl text-gray-600 dark:text-gray-400 mb-10 h-[40px]"
          >
            I am a{" "}
          ...
          <motion.a
            ...
            href="/mehad_cv.pdf" // <-- PUT YOUR CV FILE HERE in the public folder
            target="_blank"
            rel="noreferrer"
            download
          >
        ...
        >
          ...
          >
            <div className="absolute inset-0 rounded-full border-2 border-primary image-glow animate-pulse"></div>
            <img
              alt="Mehad Hossen"
